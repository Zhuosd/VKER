...
with open("emb_sum_coat.json", "r") as f:
    emb_sum_data = json.load(f)

with open("user_embeddings_coat.json", "r") as f:
...
with open("final_user_embeddings_coat.json", "w") as f:
    json.dump(final_embeddings, f, indent=4)
print("final_user_embeddings_coat.json")
